                                    ...
                                    <div class="col-sm-12">
                                        <table id="example2"
                                            ...
                                            <thead>
                                                <tr>
                                                    <td colspan="5">
                                                        <form action="{{ url('penilaians') }}"
                                                            method="POST">
                                                            @csrf

                                                            NISN <input type="" name="nisn" value="{{ $siswa->nisn }}"
                                                                class="form-control">
                                                            NAMA Siswa <input type="text" disabled
                                                                value="{{ $siswa->nama_siswa }}" class="form-control">
                                                    </td>
                                                </tr>
                                                <tr role="row">
                                                ...
                                                @foreach($subkomponens as $item)
                                                    <tr role="row" class="even">
                                                        <td class="dtr-control sorting_1" tabindex="0">
                                                            <center>{{ $loop->iteration }}</center><input
                                                                type="hidden" name="id[]"
                                                                value="{{ $item->penilaian_id }}"
                                                                class="form-control">
                                                        </td>
                                                        <td><input type="hidden" name="komponen_id[]"
                                                                class="form-control"
                                                                value="{{ $item->komponen->id }}">{{ $item->komponen->nama_komponen }}
                                                        </td>
                                                        <td><input type="hidden" name="subkomponen_id[]"
                                                                class="form-control"
                                                                value="{{ $item->id }}">{{ $item->subkomponen }}
                                                        </td>
                                                        <td><select name="nilai[]" class="form-control">
