                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="col-md-2">
                                <a href="{{ url('tahun_ajaran/create') }}"
                                    class="btn btn-block btn-primary btn-sm"> <i class="fa fa-plus"></i> Tahun Ajaran
                                </a>
                            </div>
                                            ...
                                            <tbody>
                                                @foreach($tahun_ajaran as $item)
                                                    <tr role="row" class="even">
                                                        ...
                                                        <td>{{ $item->status }}</td>
                                                        <td>
                                                            <a href="{{ url('subkomponens/edit/'.$item->id) }}"
                                                                class="label label-primary"> <i class="fa fa-edit"></i>
                                                                Edit </a>
                                                            <a href="{{ url('tahun_ajaran/destroy/'.$item->id) }}"
